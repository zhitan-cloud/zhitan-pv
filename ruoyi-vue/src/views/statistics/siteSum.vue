  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryRef" inline v-show="showSearch" label-width="68px">
      <el-form-item label="电站名称" prop="powerStationId">
        <el-select v-model="queryParams.powerStationId" placeholder="请选择电站" size="" clearable>
...
import { siteStatistics } from "@/api/manage/site"
...
function getList() {
  ...
  siteStatistics(params).then((res) => {
    loading.value = false
...
function handleChart() {
  ...
  dialogTitle.value = `电站发电统计（${queryParams.value.timeStr}）`
